...
TEST(handler, handle_option_wasm_arg) {
  ...
  {
    char *args[] = {(char *)"wasm_app/wasm/add3.wasm", (char *)"1111",
                    (char *)"2222", (char *)"3333"};
    opt->args_len = sizeof(args) / sizeof(char *);
    opt->args = args;
  ...
  {
    char *args[] = {(char *)"wasm_app/wasm/hello.wa", (char *)"second",
                    (char *)"state"};
    opt->args_len = sizeof(args) / sizeof(char *);
    opt->args = args;
...
TEST(handler, handle_option) {
  // The Test may fail due to wasm file non-exist
  {
    ...
    const char *argv[] = {"./execution", "version",
                          "run",         "wasm_app/wasm/add.wasm",
                          "-22222",      "11111"};
